...
public class UI_Tab_Button : MonoBehaviour
{
    ...
    ////    CharacterCustomizer.current.avatars[1].SetColor(color, _tab.editedCharacterPart);
    ////    switch (_tab.editedCharacterPart)
    ////    {
    ////        case CharacterPart.mainColor:
    ...
    ////    CharacterCustomizer.current.avatars[1].SetSprite(sprite, _tab.editedCharacterPart);
